...
- Architecture guidance is a bit generic.
  Evidence: "The notification should be non-intrusive but also clearly visible to the user." and "Consider using a real-time communication channel (e.g., WebSockets) for instant notifications, although for the MVP, a check on app load is sufficient."
