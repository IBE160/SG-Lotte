...
| ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Epic 1: First Plan & Foundation**              | -**Backend:** `app/api/v1/endpoints/users.py` (Authentication: use supabase auth - only change profile)), `app/services/ai_plan_generator.py` (Initial Plan Generation) `<br>` - **Frontend:** `src/app/(auth)/` (Onboarding UI), `src/app/(dashboard)/dashboard/` (Dashboard UI) |
